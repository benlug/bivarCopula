...
bivarCopula fits bivariate copula models with full Bayesian inference
...
- Flexible marginals: mix and match Normal, Lognormal, Exponential, and
  Beta distributions
- Multiple copula families: Gaussian, Clayton, and Joe copulas for
  different dependence structures
- Built-in diagnostics: Rhat, ESS, and pointwise log-likelihoods for
...
- Gaussian: `rho` in `(-1, 1)` for symmetric dependence without tail
  dependence
...
Each marginal can be set independently, giving 16 possible marginal
combinations per copula family.

## Installation

bivarCopula requires [CmdStan](https://mc-stan.org/cmdstanr/). Install
...
- [Get
  Started](https://benlug.github.io/bivarCopula/articles/bivarCopula-intro.html):
  a comprehensive introduction with examples for all copula families,
  diagnostics, and prior specification.
- [Function
  Reference](https://benlug.github.io/bivarCopula/reference/index.html):
...
- Browse the [package website](https://benlug.github.io/bivarCopula/)
  for documentation and vignettes.
- Report bugs or request features on [GitHub
  Issues](https://github.com/benlug/bivarCopula/issues).
