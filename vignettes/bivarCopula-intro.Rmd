...
`bivarCopula` fits bivariate copula models using Stan for full Bayesian inference. It jointly estimates all parameters -- both the marginal distribution parameters and the copula dependence parameter -- and returns posterior distributions for uncertainty quantification.
